...
REM longest-prefix lookup over jpn_dict.txt when either is missing.  A
REM slim release built without these runs fine; a full release needs them.
...
if not exist "%PROJECT_ROOT%\dict\kj_dict.bin" echo WARNING: kj_dict.bin missing -- viterbi engine disabled in release
if not exist "%PROJECT_ROOT%\dict\kj_conn.bin" echo WARNING: kj_conn.bin missing -- viterbi engine disabled in release
...
if exist "%PROJECT_ROOT%\README.md"     copy /Y "%PROJECT_ROOT%\README.md"    "%OUT_DIR%\" >nul
if exist "%PROJECT_ROOT%\LICENSE"       copy /Y "%PROJECT_ROOT%\LICENSE"      "%OUT_DIR%\" >nul
if exist "%PROJECT_ROOT%\CHANGELOG.md"  copy /Y "%PROJECT_ROOT%\CHANGELOG.md" "%OUT_DIR%\" >nul
if exist "%PROJECT_ROOT%\VERSION"       copy /Y "%PROJECT_ROOT%\VERSION"      "%OUT_DIR%\" >nul
